...
nb_model <- naiveBayes(Winner ~ ., data = data_train_pca)

# Prédictions des probabilités sur le jeu de test
pred_prob <- predict(nb_model, data_test_pca, type = "raw")[, 2]
...
conf_matrix <- confusionMatrix(as.factor(predictions), data_test_pca$Winner)

# Calcul de l'erreur absolue moyenne (MAE)
mae <- mean(abs(predictions - as.numeric(as.character(data_test_pca$Winner))))

# Affichage des résultats
print(conf_matrix)
print(paste("Accuracy Naïve Bayes avec PCA :", round(conf_matrix$overall["Accuracy"] * 100, 2), "%"))
print(paste("MAE Naïve Bayes avec PCA :", round(mae, 4)))
